...
//    CGFloat bounds_Width = MIN(kScreenWidth, (kScreenHeight - CGRectGetMaxY(_searchBar.frame ) - 49));
    _sphereView = [[DBSphereView alloc] initWithFrame:CGRectMake(5, 0, kScreenWidth-10, kScreenWidth-10)];
    CGPoint center = CGPointMake(kScreenWidth/2, kScreenHeight/2-100);
