...
- (void)addSelectedBar{
    ...
    self.selectedLayer.frame = CGRectMake(0, self.selectedContentView.height - 2, kScreenWidth/ 2, 2);
    self.selectedLayer.zPosition = 10;
    self.selectedLayer.backgroundColor = [UIColor darkGrayColor].CGColor;
